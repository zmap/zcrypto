...
type CertParser struct {
	selfSignedCache map[string]bool
}

func NewCertParser() *CertParser {
	return &CertParser{
		selfSignedCache: make(map[string]bool),
	}
}

// ParseCertificate parses a single certificate from the given ASN.1 DER data.
func (cp *CertParser) ParseCertificate(asn1Data []byte) (*Certificate, error) {
	...
	return cp.parseCertificate(&cert)
}

func ParseCertificate(asn1Data []byte) (*Certificate, error) {
	return NewCertParser().ParseCertificate(asn1Data)
}
