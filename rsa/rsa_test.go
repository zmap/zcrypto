...
func TestAllocations(t *testing.T) {
	...
	if allocs := testing.AllocsPerRun(100, func() {
		...
		// ZCrypto - with using bigint for the exponent, we'll use more allocations
	}); allocs > 60 {
		t.Errorf("expected less than 60 allocations, got %0.1f", allocs)
	}
	//}); allocs > 10 {
...
type testEncryptOAEPStruct struct {
	modulus string
	e       *big.Int // ZCrypto - changed to use BigInt
	d       string
...
var testEncryptOAEPData = []testEncryptOAEPStruct{
	...
	{"",
		big.NewInt(65537), // ZCrypto - use BigInt
